<!-- https://github.com/vuepont/elevenlabs-ui-vue/blob/main/packages/elements/src/shimmering-text/ShimmeringText.vue -->
...
<template>
  <Motion
    ...
    :class="
      cn(
        'relative mb-1 inline-block bg-size-[250%_100%,auto] bg-clip-text text-base text-transparent',
